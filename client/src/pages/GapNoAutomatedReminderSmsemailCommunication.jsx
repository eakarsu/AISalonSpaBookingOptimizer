...
export default function GapNoAutomatedReminderSmsemailCommunication() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-automated-reminder-smsemail-communication', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>No automated reminder SMS/email (communications route is internal)</h1>
      <p style={{ color: '#666', marginBottom: 16 }}>AISalonSpaBookingOptimizer - Gap feature</p>
