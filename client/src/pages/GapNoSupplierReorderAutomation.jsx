...
export default function GapNoSupplierReorderAutomation() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-supplier-reorder-automation', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>No supplier reorder automation</h1>
