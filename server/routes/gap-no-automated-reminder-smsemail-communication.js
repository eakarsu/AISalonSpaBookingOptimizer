...
const FEATURE_SLUG = 'no-automated-reminder-smsemail-communication';
const FEATURE_TITLE = 'No automated reminder SMS/email (communications route is internal)';
const PROJECT = 'AISalonSpaBookingOptimizer';
